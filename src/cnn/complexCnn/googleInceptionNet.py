...
import vggnet.time_tensorflow_run
...
def inception_v3_arg_scope(weight_decay=0.00004,stddev=0.1,
    ...
    with slim.arg_scope([slim.conv2d,slim.fully_connected],
                        weights_argularizer=slim.l2_regularizer(weight_decay)):
...
def inception_v3(inputs,num_classes=1000,is_training=True,dropout_keep_prob=0.8,
                 prediction_fn=slim.softmax,spatial_squeeze=True,
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            with tf.variable_scope('AuxLogits'):
                ...
                aux_logits = slim.conv2d(
                    ...
                    padding='VALID', scope='Conv2d_2a_{}x{}')
                aux_logits = slim.conv2d(
